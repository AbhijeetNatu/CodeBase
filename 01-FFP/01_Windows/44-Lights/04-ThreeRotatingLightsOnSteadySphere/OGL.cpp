...
GLfloat MaterialShininess = 50.0f;		//Can try 128 later
...
void display(void)
{
	...
	LightPositionTwo[0] = cos(LightAngleTwo) * radius;
...
void update(void)
{
	...
	LightAngleZero = LightAngleZero + 0.10f;
	if (LightAngleZero >= 360.0f)
		LightAngleZero = LightAngleZero - 360.0f;

	LightAngleOne = LightAngleOne + 0.10f;

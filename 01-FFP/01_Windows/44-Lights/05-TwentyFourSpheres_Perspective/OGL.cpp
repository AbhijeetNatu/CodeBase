...
void display(void)
{
	...
	if (keypressed == 1)	//X Axis Rotation
	{
		...
		LightPosition[1] = cos(AngleForXRotation) * radius;
		LightPosition[2] = sin(AngleForXRotation) * radius;
	...
	else if (keypressed == 2)	//Y axis rotation
	{
		...
		LightPosition[0] = cos(AngleForYRotation) * radius;
		LightPosition[2] = sin(AngleForYRotation) * radius;
	...
	else if (keypressed == 3)	//Z axis Rotation
	{
		...
		LightPosition[0] = cos(AngleForZRotation) * radius;
		LightPosition[1] = sin(AngleForZRotation) * radius;
...
void update(void)
{
	...
	if (keypressed == 1)
	{
		AngleForXRotation = AngleForXRotation + 0.08f;
	...
	if (keypressed == 2)
	{
		AngleForYRotation = AngleForYRotation + 0.08f;
	...
	if (keypressed == 3)
	{
		AngleForZRotation = AngleForZRotation + 0.08f;

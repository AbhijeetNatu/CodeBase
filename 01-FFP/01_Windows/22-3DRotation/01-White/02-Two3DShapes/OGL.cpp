...
void display(void)
{
	...
	glRotatef(anglePyramid,0.0f,1.0f,0.0f);   //Y AXIS SPINNING TRIANGLE
	...
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex3f(-1.0f, -1.0f, 1.0f);		//because pudhe ahe..(Z=1)
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex3f(1.0f, -1.0f, 1.0f);		//because it is in front(Z=1)

	//Right Face
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex3f(0.0f, 1.0f, 0.0f);
	glColor3f(1.0f, 1.0f, 1.0f);		//so that it will come in conituation with front face
	glVertex3f(1.0f, -1.0f, 1.0f);
	glColor3f(1.0f, 1.0f, 1.0f);		
	glVertex3f(1.0f, -1.0f, -1.0f);		// Z laa mage ahe haa !
	...
	glRotatef(angleCube,1.0f,1.0f,1.0f);	// X,Y,Z i.e all axis or TriAxial AXIS ROLLING RECTANGLE 
	...
	//Left Face
	glColor3f(1.0f, 1.0f, 1.0f);		//Cyan = Green + Blue
	glVertex3f(-1.0f, 1.0f, 1.0f);		//Right Top
	glVertex3f(-1.0f, -1.0f, -1.0f);	//Left Top
	glVertex3f(-1.0f, 1.0f, -1.0f);		//Left Bottom
	glVertex3f(-1.0f, -1.0f, 1.0f);		//Right Bottom
	...
	//Top Face
	glColor3f(1.0f, 1.0f, 1.0f);		//Magenta =red +blue
	glVertex3f(1.0f, 1.0f, -1.0f);
	glVertex3f(-1.0f, 1.0f, -1.0f);
	glVertex3f(-1.0f, 1.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, 1.0f);
	...
	//Bottom Face
	glColor3f(1.0f,1.0f,1.0f);		//yellow = red + green
	glVertex3f(1.0f, -1.0f, -1.0f);
	glVertex3f(-1.0f, -1.0f, -1.0f);
	glVertex3f(-1.0f, -1.0f, 1.0f);
	glVertex3f(1.0f, -1.0f, 1.0f);
...
void CenterWindow(HWND hwnd) 
{
	...
	//int WIN_WIDTH;  // What to do?
	//int WIN_HEIGHT; // What to do?

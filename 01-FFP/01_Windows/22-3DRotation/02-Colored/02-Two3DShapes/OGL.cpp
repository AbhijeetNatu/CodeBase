...
int initialize(void)
{
	...
	pfd.cColorBits = 32;	//count of Color Bits
	pfd.cRedBits = 8;
	pfd.cGreenBits = 8;
	pfd.cBlueBits = 8;
	pfd.cAlphaBits = 8;
...
void display(void)
{
	...
	glColor3f(0.0f, 1.0f, 0.0f);		//		   (RED, GREEN, BLUE)  
	...
	glColor3f(0.0f, 0.0f, 1.0f);		//so that it will come in continuation with front face

...
#include <math.h>		// Use for PI and Trigonometric functions(cos,sin..)
#include "OGL.h"
...
int initialize(void)
{
	...
	iPixelFormatIndex = ChoosePixelFormat(ghdc, &pfd);
		...
		//Initialization of Translation Matrix Array
		...
		//Initialization of Scale Matrix Array
...
void resize(int width, int height)
{
	...
	if (width <= height)
	{
		l = -100.0f;
		r = 100.0f;
		b = (-100.0f * ((GLfloat)width / (GLfloat)height));
		t = (100.0f * ((GLfloat)width / (GLfloat)height));
		n = -100.0f;
		f = 100.0f;
	}
	else
	...
	//initialization of Ortho Matrix
	orthoMatrix[0] = 2 / (r - l);
	orthoMatrix[1] = 0.0f;
	orthoMatrix[2] = 0.0f;
	orthoMatrix[3] = 0.0f;
...
void display(void)
{
	...
	glLoadMatrixf(identityMatrix);		//f for float .. Same as glLoadIdentity()
	...
	float angle = angleCube * M_PI / 180.0f;	//Use in matrices
	...
	glVertex3f(50.0f, 50.0f, 50.0f);    //Right top
	glVertex3f(-50.0f, 50.0f, 50.0f);	 //Left Top
	glVertex3f(-50.0f, -50.0f, 50.0f);		//Left Bottom
	glVertex3f(50.0f, -50.0f, 50.0f);		//Right Bottom

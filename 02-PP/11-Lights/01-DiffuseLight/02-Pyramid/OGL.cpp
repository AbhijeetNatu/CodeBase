...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Abhijeet Natu : Diffuse Light on Pyramid"),
...
void display(void)
{
	...
	rotationMatrix_x = rotate(anglePyramid, 1.0f, 0.0f, 0.0f);		//X Rotation
	rotationMatrix_y = rotate(anglePyramid, 0.0f, 1.0f, 0.0f);
	rotationMatrix_z = rotate(anglePyramid, 0.0f, 0.0f, 1.0f);

	rotationMatrix = rotationMatrix_y; // * rotationMatrix_y * rotationMatrix_z;

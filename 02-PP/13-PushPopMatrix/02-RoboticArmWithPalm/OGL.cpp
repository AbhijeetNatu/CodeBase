...
mat4 matrixStack[MATRIX_STACK_SIZE];
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szAppName,
        TEXT("Abhijeet Natu : Robotic Arm With Palm"),
...
int initialize(void)
{
    ...
    // For Color
    glVertexAttrib3f(AAN_ATTRIBUTE_COLOR, 0.5f, 0.35f, 0.05f);
...
void display(void)
{
    ...
    pushMatrix(modelMatrix);
    {
        ...
        pushMatrix(modelMatrix);
        {
            scaleMatrix = vmath::scale(0.5f, 0.3f, 1.0f);
            modelMatrix = modelMatrix * scaleMatrix;
...
void initializeMatrixStack(void)
{
    // Code
    matrixStackTop = 0;
    for (int i = matrixStackTop; i < MATRIX_STACK_SIZE; i++)
    {
...
void pushMatrix(mat4 matrix)
{
    ...
    if (matrixStackTop > (MATRIX_STACK_SIZE - 1))
    {

...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpSZCmdLine, int iCmdShow) //lpSZCmdLine is like char *argv[] in main() of CUI programming
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName,
		TEXT("Abhijeet Natu : Graph Paper With Shapes"),
...
int initialize(void)
{
	...
	glVertexAttribPointer(AAN_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 0, NULL);
...
void display(void)
{
	...
	translationMatrix = vmath::translate(0.0f, 0.5f, -9.5f);

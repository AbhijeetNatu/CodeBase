...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Abhijeet Natu : TWO 2D SHAPES (COLORED) ROTATION"),
...
int initialize(void)
{
	...
	iPixelFormatIndex = ChoosePixelFormat(ghdc, &pfd);
		...
		glBindAttribLocation(shaderProgramObject, AMC_ATTRIBUTE_COLOR, "a_color");			//chukla tar andhaar FIX !!!
		...
		glVertexAttribPointer(AMC_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 0, NULL);		//r,g,b
...
void display(void)
{
	...
	rotationMatrix = rotate(angleTriangle, 0.0f, 1.0f, 0.0f);	//Spinning
	...
	translationMatrix = translate(1.5f, 0.0f, -6.0f);
	rotationMatrix = rotate(angleSquare, 1.0f, 0.0f, 0.0f);		//X Rotation
